...
// Forking config.
var addressFormat = "^QPSA([a-zA-Z0-9]{95}|[a-zA-Z0-9]{183})$"
var divisor float64 = 100000000 // This is 100000000 for QPSA
var transactionFee = 100000 // This is 0.001 for TRTL
